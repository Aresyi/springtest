package com.ydj.test.cat.integration.catclint;
...
public class HttpCatFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
        ...
        if(null != req.getHeader(MyCatConstants.CAT_HTTP_HEADER_ROOT_MESSAGE_ID)){
            ...
            try {
                ...
                createProviderCross(req,transaction);
    ...
    private void logCatMessageId(HttpServletResponse res) {
        ...
        if (isTraceMode) {
            ...
            System.out.println("HttpCatFilter>>>>>>>>>>>>::"+id);
    ...
    private Cat.Context initContext(HttpServletRequest req){
        Cat.Context context = new HTTPCatContext();
    ...
    private void createProviderCross(HttpServletRequest req,Transaction transaction){
        String consumerAppName = req.getParameter("consumerAppName");
        Event crossAppEvent = Cat.newEvent(MyCatConstants.PROVIDER_CALL_APP, consumerAppName);
        Event crossServerEvent = Cat.newEvent(MyCatConstants.PROVIDER_CALL_SERVER, req.getRemoteHost());
